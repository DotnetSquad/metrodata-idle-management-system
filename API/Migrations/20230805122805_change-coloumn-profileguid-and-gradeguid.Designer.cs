...
namespace API.Migrations
{
    ...
    [Migration("20230805122805_change-coloumn-profileguid-and-gradeguid")]
    partial class changecoloumnprofileguidandgradeguid
    {
            ...
            modelBuilder.Entity("API.Models.EmployeeJob", b =>
                {
                    ...
                    b.HasIndex("InterviewGuid")
                        .IsUnique()
                        .HasFilter("[interview_guid] IS NOT NULL");
